...
public class PanelTeclado extends JPanel {
    private BotonTeclado[] botones = {new BotonTeclado("Q",0,0), new BotonTeclado("W", 55,0), new BotonTeclado("E", 110,0), new BotonTeclado("R", 165,0), new BotonTeclado("T", 220,0), new BotonTeclado("Y", 275,0), new BotonTeclado("U", 330,0), new BotonTeclado("I", 385,0), new BotonTeclado("O", 440,0), new BotonTeclado("P", 495,0)
    ...
    private BotonEnviar enviar = new BotonEnviar("Enviar", 0, 130);
    private BotonBorrar borrar = new BotonBorrar("Borrar", 475, 130);
    PanelTeclado() {
        super(null);
